        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-gray-400 hover:text-medical-blue transition-colors text-sm"
                  >
                    {link.name}
                  </a>
                </li>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-center space-x-3 text-gray-400 hover:text-medical-blue transition-colors text-sm"
                >
              ...
              <li>
                <a
                  href={`tel:${siteInfo.phone2.replace(/\s/g, '')}`}
                  className="flex items-center space-x-3 text-gray-400 hover:text-medical-blue transition-colors text-sm"
                >
                  <Phone className="w-4 h-4 flex-shrink-0" />
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-6 inline-flex items-center space-x-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} {siteInfo.name}. Tüm hakları saklıdır.
            </p>
