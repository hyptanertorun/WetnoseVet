...
export default function CustomCursor() {
  ...
  useEffect(() => {
    // Hide on mobile/touch devices or admin pages
    if ('ontouchstart' in window || isAdminPage) return
  ...
  return (
    <>
      ...
      {/* Hide default cursor globally - only on non-admin pages */}
      <style jsx global>{`
        body:not(.admin-page) * {
