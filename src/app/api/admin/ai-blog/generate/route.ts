// AI Blog Generation - OPTIONAL FEATURE
  ...
  try {
    ...
    if (!openaiKey) {
      return NextResponse.json({
        ...
        message: 'AI blog üretimi henüz yapılandırılmamış. Lütfen OPENAI_API_KEY veya EMERGENT_LLM_KEY ortam değişkenini ayarlayın.'
      }, { status: 503 })
    }
    ...
    return NextResponse.json({
      ...
      message: 'AI blog üretimi şu anda geliştirilme aşamasında. Lütfen daha sonra tekrar deneyin.'
    }, { status: 501 })
  } catch (error) {
    console.error('AI blog generation error:', error)
    return NextResponse.json({ detail: 'AI blog üretimi sırasında hata oluştu' }, { status: 500 })
  }
}
